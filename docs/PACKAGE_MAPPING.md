...
**Release 附件**：`medleakaudit_01_main_audit.zip`
...
**Release 附件**：`medleakaudit_02_deployment_diagnostics.zip`
...
**Release 附件**：`medleakaudit_03_cross_pipeline_bm25_topk.zip`
...
| 附件 | 说明 |
|---|---|
| `medleakaudit_01_main_audit.zip` | 主工程审计公开脱敏包（由原始 v5.1.1 归档脱敏/重组生成） |
| `medleakaudit_02_deployment_diagnostics.zip` | 部署诊断支撑包（v2 允许名单） |
| `medleakaudit_03_cross_pipeline_bm25_topk.zip` | 第二工程跨管线公开脱敏包（由原始 v6 归档脱敏/重组生成） |
